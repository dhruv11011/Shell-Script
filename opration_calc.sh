#This is program for making arithmatic oprations
...
val= expr $a + $b 
echo "This is Addition of $a + $b : $val"

val= expr $a - $b 
echo "This is Substaction of $a - $b : $val"

val= expr $a \* $b 
echo "This is Multiplication of $a * $b : $val"

val= expr $a / $b 
echo "This is Division of $a / $b : $val"

val= expr $a % $b 
echo "This is Modulas of $a % $b : $val"
